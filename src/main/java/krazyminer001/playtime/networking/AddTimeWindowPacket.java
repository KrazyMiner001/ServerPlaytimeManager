...
public record AddTimeWindowPacket(TimePeriodString timePeriodString) implements CustomPayload {
    ...
    public static final PacketCodec<RegistryByteBuf, AddTimeWindowPacket> CODEC = PacketCodec.tuple(
            TimePeriodString.PACKET_CODEC, AddTimeWindowPacket::timePeriodString,
